...
export const STAGES: Stage[] = [
  ...
  { id: 85, nameEn: "Fire Alarm Systems details", nameMl: "ഫയർ & സ്മോക്ക് അലാറം സിസ്റ്റം", startPoint: 2421, endPoint: 2460, section: "Section 4: Sustainability & Modern Systems (സുസ്ഥിരതയും ആധുനിക സംവിധാനങ്ങളും)" },
